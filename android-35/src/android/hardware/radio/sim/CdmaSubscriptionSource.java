...
public @interface CdmaSubscriptionSource {
  ...
  interface $ {
    static String toString(int _aidl_v) {
      if (_aidl_v == RUIM_SIM) return "RUIM_SIM";
      if (_aidl_v == NV) return "NV";
