...
public interface IVibrationSession extends android.os.IInterface
{
  ...
  /** Default implementation for IVibrationSession. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.vibrator.IVibrationSession
  {
    ...
    /**
     * Cast an IBinder object into an android.hardware.vibrator.IVibrationSession interface,
     * generating a proxy if needed.
     */
    public static android.hardware.vibrator.IVibrationSession asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof android.hardware.vibrator.IVibrationSession))) {
        return ((android.hardware.vibrator.IVibrationSession)iin);
      }
      return new android.hardware.vibrator.IVibrationSession.Stub.Proxy(obj);
    }
    ...
    static final int TRANSACTION_abort = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
    static final int TRANSACTION_getInterfaceVersion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16777214);
    static final int TRANSACTION_getInterfaceHash = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16777213);
  }
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "android$hardware$vibrator$IVibrationSession".replace('$', '.');
