...
public interface ISoundTriggerHwGlobalCallback extends android.os.IInterface
{
  ...
  /** Default implementation for ISoundTriggerHwGlobalCallback. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback
  {
    ...
    /**
     * Cast an IBinder object into an android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback interface,
     * generating a proxy if needed.
     */
    public static android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback))) {
        return ((android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback)iin);
      }
      return new android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements android.hardware.soundtrigger3.ISoundTriggerHwGlobalCallback
    {
      ...
      @Override public void onResourcesAvailable() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onResourcesAvailable, _data, _reply, 0);
          if (!_status) {
    ...
    static final int TRANSACTION_onResourcesAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
