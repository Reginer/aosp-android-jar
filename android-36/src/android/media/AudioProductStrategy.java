...
/** {@hide} */
public class AudioProductStrategy implements android.os.Parcelable
{
  /** Interpreted as product_strategy_t. */
  public int id = 0;
  public java.lang.String name;
  public android.media.AudioAttributesEx[] audioAttributes;
  public static final android.os.Parcelable.Creator<AudioProductStrategy> CREATOR = new android.os.Parcelable.Creator<AudioProductStrategy>() {
    @Override
    public AudioProductStrategy createFromParcel(android.os.Parcel _aidl_source) {
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      audioAttributes = _aidl_parcel.createTypedArray(android.media.AudioAttributesEx.CREATOR);
    } finally {
