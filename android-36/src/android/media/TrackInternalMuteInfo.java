...
public class TrackInternalMuteInfo implements android.os.Parcelable
{
  /** Interpreted as audio_port_handle_t. */
  public int portId = 0;
  public boolean muted = false;
  public static final android.os.Parcelable.Creator<TrackInternalMuteInfo> CREATOR = new android.os.Parcelable.Creator<TrackInternalMuteInfo>() {
    @Override
    public TrackInternalMuteInfo createFromParcel(android.os.Parcel _aidl_source) {
