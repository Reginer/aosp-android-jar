 ...
 */
public final class ProviderServiceTaskCancelledException extends IllegalStateException {
    /** Default constructor. */
    public ProviderServiceTaskCancelledException() {
        super();
    }

    /** Constructor with a customized error message. */
    public ProviderServiceTaskCancelledException(String message) {
        super(message);
    }
}
