    ...
    extends ShortBuffer
{
   ...
   // Android-added: Merge the Read-only buffer class with this Read-Write buffer class.
    private HeapShortBuffer(int cap, int lim, boolean isReadOnly) {
        super(-1, 0, lim, cap, new short[cap], 0);
   ...
   // Android-added: Merge the Read-only buffer class with this Read-Write buffer class.
    private HeapShortBuffer(short[] buf, int off, int len, boolean isReadOnly) {
        super(-1, off, off + len, buf.length, buf, 0);
        this.isReadOnly = isReadOnly;
    }
    ...
    // Android-removed: Removed MemorySegmentProxy to be supported yet.
    private HeapShortBuffer(short[] buf,
    ...
    public ShortBuffer put(ShortBuffer src) {
        ...
        // Android-added: Merge the Read-only buffer class with this Read-Write buffer class.
        throwIfReadOnly();
        if (src instanceof HeapShortBuffer sb) {
            int n = sb.remaining();
            if (n > remaining())
                throw new BufferOverflowException();
