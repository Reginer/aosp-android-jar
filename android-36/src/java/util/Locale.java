...
// Android-changed: In "Legacy language codes" mention that new codes are used for apps targeting
// an running on at least Android V. Also "Backwards compatibility" part of that section was
// removed.
/**
 ...
 * {@code in}. For apps targeting and running on Android V and later, this is no longer the case.
 * Each language maps to its new form; {@code iw} maps to {@code he}, {@code ji}
...
public final class Locale implements Cloneable, Serializable {
    ...
    private static Locale initDefault(Locale.Category category) {
        ...
        final Locale locale = NoImagePreloadHolder.defaultLocale;
        // BEGIN Android-changed: Short-circuit legacy security code.
        /*
        Properties props = GetPropertyAction.privilegedGetProperties();
        ...
        */
        return getInstance(
            System.getProperty(category.languageKey, locale.getLanguage()),
            System.getProperty(category.scriptKey, locale.getScript()),
            System.getProperty(category.countryKey, locale.getCountry()),
            System.getProperty(category.variantKey, locale.getVariant()),
            null);
        // END Android-changed: Short-circuit legacy security code.
    }
    ...
    // Android-changed: Removed documentation references to LocaleServiceProvider and do not promise
    // presence of Locale.ROOT.
    /**
    ...
    public static Stream<Locale> availableLocales() {
        ...
        return ICU.streamAvailableLocales();
    }
     ...
     * defined in ISO 639. Can be used to obtain Locales.
     * <p>
     * <b>Note:</b>
     * <ul>
    ...
    */
    ...
    // Android-removed: LanguageTag.caseFoldTag is not imported yet.
    /*
...
// END Android-changed: Documentation and behavior of getDisplay*().
    ...
    */
    ...
    private static class NoImagePreloadHolder {
        public static volatile Locale defaultLocale = initDefault();
    }
