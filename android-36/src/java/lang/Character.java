...
class Character implements java.io.Serializable, Comparable<Character>, Constable {
    ...
    */
    ...
    public static boolean isEmoji(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EMOJI);
    }
    ...
    public static boolean isEmojiPresentation(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EMOJI_PRESENTATION);
    }
    ...
    public static boolean isEmojiModifier(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EMOJI_MODIFIER);
    }
    ...
    public static boolean isEmojiModifierBase(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EMOJI_MODIFIER_BASE);
    }
    ...
    public static boolean isEmojiComponent(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EMOJI_COMPONENT);
    }
    ...
    public static boolean isExtendedPictographic(int codePoint) {
        ...
        return ICU.hasBinaryProperty(codePoint, UProperty.EXTENDED_PICTOGRAPHIC);
    }
