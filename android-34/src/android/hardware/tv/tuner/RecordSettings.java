...
public class RecordSettings implements android.os.Parcelable
{
  ...
  public static final android.os.Parcelable.Creator<RecordSettings> CREATOR = new android.os.Parcelable.Creator<RecordSettings>() {
    @Override
    public RecordSettings createFromParcel(android.os.Parcel _aidl_source) {
