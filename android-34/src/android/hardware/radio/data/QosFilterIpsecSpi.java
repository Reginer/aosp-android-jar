...
public final class QosFilterIpsecSpi implements android.os.Parcelable {
  ...
  public String toString() {
    switch (_tag) {
    case noinit: return "android.hardware.radio.data.QosFilterIpsecSpi.noinit(" + (getNoinit()) + ")";
    case value: return "android.hardware.radio.data.QosFilterIpsecSpi.value(" + (getValue()) + ")";
    }
